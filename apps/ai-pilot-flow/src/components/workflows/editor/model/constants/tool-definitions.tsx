...
export const TOOL_DEFINITIONS: readonly ToolDefinition[] = [
    ...
    outputPorts: [
      {
        ...VALUE_OUTPUT_PORT,
        label: "Number",
        portToneClassName: "border-[#22c55e]/60 bg-[#1c1d26]",
        labelToneClassName: "text-[#22c55e]",
      },
    ],
    runLabel: "Set Value",
    showRunAction: false,
    renderBody: renderNumberBody,
    renderFooter: () => <></>,
    width: "w-[300px]",
    className: "rounded-md",
  }),
  ...
  createStandardToolDefinition({
    ...
    showRunAction: false,
    getPortOffset: () => 59,
    renderBody: renderListSelectorBody,
    renderFooter: () => <></>,
    width: "w-[300px]",
    className: "rounded-md",
  }),
    ...
    outputPorts: [
      {
        ...VALUE_OUTPUT_PORT,
        label: "Seed",
        portToneClassName: "border-[#f97316]/60 bg-[#1c1d26]",
        labelToneClassName: "text-[#f97316]",
      },
    ],
    runLabel: "Set Seed",
    showRunAction: false,
    getPortOffset: () => 59,
    renderBody: renderSeedBody,
    renderFooter: () => <></>,
    width: "w-[320px]",
    className: "rounded-md",
  }),
