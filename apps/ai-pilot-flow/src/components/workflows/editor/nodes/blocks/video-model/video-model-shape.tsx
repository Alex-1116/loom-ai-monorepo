...
export function renderVideoModelBody({ isRunning }: { isRunning: boolean }) {
  return (
    <div
      className={cn(
        "relative aspect-video w-full overflow-hidden rounded-xl bg-[#1f212b]",
...
export function renderVideoModelFooter({
  addInputLabel,
  runLabel,
  showAddInputAction,
  showRunAction,
